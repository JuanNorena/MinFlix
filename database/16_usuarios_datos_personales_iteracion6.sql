...
DECLARE
  ...
  PROCEDURE MARCAR_NOT_NULL_SI_APLICA(
...
BEGIN
  ...
  -- Paso 6: marcar columnas como NOT NULL solo si aun son nullable.
  -- En el esquema actual estas columnas ya nacen NOT NULL desde el script 01.
  MARCAR_NOT_NULL_SI_APLICA(
    'TELEFONO',
    'ALTER TABLE USUARIOS MODIFY (TELEFONO NOT NULL)'
  );
  MARCAR_NOT_NULL_SI_APLICA(
    'FECHA_NACIMIENTO',
  ...
  MARCAR_NOT_NULL_SI_APLICA(
    'CIUDAD_RESIDENCIA',
    'ALTER TABLE USUARIOS MODIFY (CIUDAD_RESIDENCIA NOT NULL)'
  );
END;
/
